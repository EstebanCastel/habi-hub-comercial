...
export default function ConversionSellerPage() {
  ...
  const nav = `<nav class="bg-gray-900/80 backdrop-blur border-b border-gray-800 px-6 py-3 flex items-center gap-3 sticky top-0 z-50">
    ...
    <span class="text-gray-300">Conversión por Seller</span>
  </nav>`;
  const scripts = `<script src="https://cdn.jsdelivr.net/npm/chart.js@4.4.7/dist/chart.umd.min.js"></script><script src="/js/conversion_seller.js"></script><script src="https://cdn.jsdelivr.net/npm/alpinejs@3.14.9/dist/cdn.min.js" defer></script>`;
